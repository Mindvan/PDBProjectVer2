...
namespace University.DAL.Repository
{
    public partial class UniversityContext : DbContext
    {
        ...
        public virtual DbSet<Hometask> StudHws { get; set; }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Attendance>(entity =>
            {
                ...
                entity.HasIndex(e => e.LectionLectorID, "IX_attendance_Lr_Ln_Id");

                entity.HasIndex(e => e.StudentId, "IX_attendance_Student_Id");

                entity.Property(e => e.Id).ValueGeneratedNever();

                entity.Property(e => e.LectionLectorID).HasColumnName("Lr_Ln_Id");

                entity.Property(e => e.StudentId).HasColumnName("Student_Id");

                entity.HasOne(d => d.LectionLector)
                    .WithMany(p => p.Attendances)
                    .HasForeignKey(d => d.LectionLectorID)
            ...
            {
                entity.HasIndex(e => e.LectionLectorID, "IX_Homeworks_Lr_ln_ID");
